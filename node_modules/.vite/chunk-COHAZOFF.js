...
var reIsNative = RegExp("^" + funcToString3.call(hasOwnProperty6).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
//# sourceMappingURL=chunk-COHAZOFF.js.map
